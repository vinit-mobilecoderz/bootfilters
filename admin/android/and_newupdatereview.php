		   ...
		   $question = array_values($jsondata['questions']);
			...
			if($insert_q)
	           ...
	           else
	           {
	           	...
	           	foreach($question as $questions)
				{
				$query3 = "UPDATE `boot_reviews` SET  `answer1` =  '".mysqli_real_escape_string($con, $questions['answer'])."' WHERE  `question_id` ='".mysqli_real_escape_string($con, $questions['question_id'])."' and reviewId= '".$reviewid."'";
