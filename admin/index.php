...
<html ng-app="angularTable">
	<head>
		...
		<link rel="shortcut icon" href="https://www.bootfitters.com/themes/boots/favicon.ico" type="image/vnd.microsoft.icon" />
    ...
    <?php include("header.php");?>
		...
		<div class="container" ng-controller="listdata" ng-init="getData()">
        

        <div class="preload" ng-show="loading">
    ...
    <div class="bs-component" >
                ...
                <a ng-show="users.length" href="csv_download.php"> <button class="btn btn-success" style="float:right;">download Excel File</button></a>
            </div>  
