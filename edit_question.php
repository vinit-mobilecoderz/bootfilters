				...
				<div class="tab-content">
				 <div id="bootdata" class="tab-pane fade in active">
				      <h3>Boot Data</h3>
				      		...
				      		<?php   $boot_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='Boot Data'";
...
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','boot_data<?=$count?>','boot<?=$count?>')" >
				     </span>
				      </div>
	 <div class="help-box" id="boot<?=$count?>"></div>
				    ...
				    <div id="first_impress" class="tab-pane fade">
				      <h3>Menu 1</h3>
				      			...
				      			<?php  
				      			 $first_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='First Impressions'";
				    ...
				    <span class="input-group-btn">
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','first_data<?=$count?>','first<?=$count?>')" >
				     </span>
				      </div>
	 <div class="help-box" id="first<?=$count?>"></div>
				    ...
				    <div id="fit_impress" class="tab-pane fade">
				      <h3>Menu 2</h3>
				      			...
				      			<?php  
				      			 $fit_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='Fit Impressions'";
				    ...
				    <span class="input-group-btn">
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','fit_data<?=$count?>','fit<?=$count?>')" >
				     </span>
				      </div>
	 <div class="help-box" id="fit<?=$count?>"></div>
				    ...
				    <div id="flex" class="tab-pane fade">
				      <h3>Menu 3</h3>
				      			...
				      			<?php  
				      			 $flex_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='Flex, Tongue, Cuff Height'";
				    ...
				    <span class="input-group-btn">
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','flex_data<?=$count?>','flex<?=$count?>')" >
				     </span>
				      </div>
	 <div class="help-box" id="flex<?=$count?>"></div>
				    ...
				    <div id="Stance_impress" class="tab-pane fade">
				      <h3>Menu 3</h3>
				      			...
				      			<?php  
				      			 $Stance_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='Stance Impressions'";
				    ...
				    <span class="input-group-btn">
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','Stance_data<?=$count?>','Stance<?=$count?>')" >
				     </span>
				      </div>
	 <div class="help-box" id="Stance<?=$count?>"></div>
				    ...
				    <div id="dry_test" class="tab-pane fade">
				      <h3>Menu 3</h3>
				      			...
				      			<?php  
				      			 $dry_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='DRY-TEST SUMMARY'";
				    ...
				    <span class="input-group-btn">
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','dry_data<?=$count?>','dry<?=$count?>')" >
				     </span>
				      </div>
	 <div class="help-box" id="dry<?=$count?>"></div>
				    ...
				    <div id="other_fit" class="tab-pane fade">
				      <h3>Menu 3</h3>
				      			...
				      			<?php  
				      			 $Other_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='Other Fit Stuff & Gizmos'";
				     ...
				     <input type="text" id="dry_data<?=$count?>" name="questions" value="<?=$row['questions']?>" class="form-control">
				    <span class="input-group-btn">
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','dry_data<?=$count?>','other<?=$count?>')" >
				     </span>
				      </div>
	 <div class="help-box" id="other<?=$count?>"></div>
				    ...
				    <div id="on_show" class="tab-pane fade">
				      <h3>Menu 3</h3>
				      			...
				      			<?php  
				      			 $Summary_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='Summary on-snow test'";
				    ...
				    <span class="input-group-btn">
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','show_data<?=$count?>','show<?=$count?>')" >
				     </span>
				      </div>
	 <div class="help-box" id="show<?=$count?>"></div>
				    ...
				    <div id="custom_tech" class="tab-pane fade">
				      <h3>Menu 3</h3>
				      			...
				      			<?php  
				      			 $custom_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='Custom Technology/Fitting (Ignore if not relevant to boot model)'";
				     ...
				     <input type="text" id="show_data<?=$count?>" name="questions" value="<?=$row['questions']?>" class="form-control">
				    <span class="input-group-btn">
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','show_data<?=$count?>','custom<?=$count?>')" >
				     </span>
				      </div>
	 <div class="help-box" id="custom<?=$count?>"></div>
				    ...
				    <div id="hike_mode" class="tab-pane fade">
				      <h3>Menu 3</h3>
				      			...
				      			<?php  
				      			 $hike_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='Hike Mode Boot Scores (ignore if not relevant to boot model)'";
				    ...
				    <span class="input-group-btn">
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','hike_data<?=$count?>','hike<?=$count?>')" >
				     </span>
				      </div>
	 <div class="help-box" id="hike<?=$count?>"></div>
				    ...
				    <div id="rating" class="tab-pane fade">
				      <h3>Menu 3</h3>
				      			...
				      			<?php  
				      			 $rating_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='RATINGS SELECTIONS'";
				    ...
				    <span class="input-group-btn">
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','rating_data<?=$count?>','rating<?=$count?>')" >
				     </span>
				      </div>
	 <div class="help-box" id="rating<?=$count?>"></div>
				    ...
				    <div id="final_thought" class="tab-pane fade">
				      <h3>Menu 3</h3>
				      			...
				      			<?php  
				      			 $final_data = "SELECT `questions`,`id` FROM `boot_questions` WHERE sections='Final Thoughts'";
				    ...
				    <span class="input-group-btn">
<input type="button" name="submit" value="submit" class="btn btn-primary" onclick="getquestion('<?=$row['id']?>','final_data<?=$count?>','final<?=$count?>')" >
				     </span>
				      </div>
