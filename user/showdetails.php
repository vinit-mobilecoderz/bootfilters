...
href="#dry_test">DRY-TEST SUMMARY</a></li>
                    <li class=""><a class="btn btn-default btn-block"data-toggle="pill"  

href="#other_fit">Cool Features & New Technology</a></li>
<li class=""><a class="btn btn-default btn-block" data-toggle="pill"  
...
onclick="getquestion('form1','boot1')" >
                      ...
                      <?php 
                        ...
                        $boot_data = "SELECT DISTINCT `question_id`,`questions`,`answer1` FROM 

`boot_reviews` WHERE sections='First Impressions' AND reviewId='".$id."'";
 ...
 <input type="button" name="submit" value="Update" class="btn btn-primary" onclick="getquestion('form2','boot2')" >
                    ...
                    <div id="fit_impress" class="tab-pane fade">
                      ...
                      <?php 
                        ...
                        $boot_data = "SELECT DISTINCT boot_reviews.question_id, boot_reviews.questions, boot_reviews.answer1, boot_questions.id,boot_questions.type FROM boot_reviews INNER JOIN boot_questions ON boot_reviews.question_id = boot_questions.id where  (boot_reviews.sections ='Fit Impressions' AND boot_reviews.reviewId= '".$id."') ";
